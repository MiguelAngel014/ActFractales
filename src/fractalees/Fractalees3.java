 ...
 * @author itoan
 */
public class Fractalees3 extends JPanel {
    ...
    public Fractalees3() {
        ...
        generateMandelbrotCuartaPotencia();
    }

    private void generateMandelbrotCuartaPotencia() {
        for (int x = 0; x < WIDTH; x++) {
            for (int y = 0; y < HEIGHT; y++) {
                ...
                while (zx * zx + zy * zy < 4 && iter < MAX_ITER) {
                    double tempX = zx * zx * zx * zx - 6 * zx * zx * zy * zy + zy * zy * zy * zy + cX;
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> {
            JFrame frame = new JFrame("Mandelbrot Cuarta Potencia Set");
            frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
            frame.add(new Fractalees3());
            frame.pack();
